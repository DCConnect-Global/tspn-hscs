...
export interface components {
  schemas: {
    ...
    AccountInfo: {
      ...
      staked_account_id: components["schemas"]["EntityId"];
      /**
       * Format: int64
       * @description The id of the node to which this account is staking
       */
      staked_node_id: number | null;
      stake_period_start: components["schemas"]["TimestampNullable"];
    };
    ...
    ContractLog: components["schemas"]["ContractResultLog"] & ({
       ...
       */
      block_number?: number;
      root_contract_id?: components["schemas"]["EntityId"];
      timestamp?: components["schemas"]["Timestamp"];
      /**
    ...
    ContractResult: {
      ...
      bloom?: components["schemas"]["Bloom"];
      /**
    ...
    NetworkNode: {
      ...
      staking_period: components["schemas"]["TimestampRangeNullable"];
      timestamp: components["schemas"]["TimestampRange"];
    };
    ...
    TimestampRange: {
      ...
      to?: components["schemas"]["TimestampNullable"];
    };
    /** @description A timestamp range an entity is valid for */
